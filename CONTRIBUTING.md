# Contributing to APISpec-fromfile
...
`APISpec-fromfile` is licensed under the Apache License 2.0. Anything
contributed to `APISpec-fromfile` must be released under this license.
